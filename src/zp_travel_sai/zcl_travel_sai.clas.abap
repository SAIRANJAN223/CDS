CLASS zcl_travel_sai DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_TRAVEL_SAI IMPLEMENTATION.
...
*   clear data
    DELETE FROM zdb_travel_sai.

    "insert travel demo data
    INSERT zdb_travel_sai  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |Demo data generated for table ZDB_TRAVEL_SAI.| ).
  ENDMETHOD.
ENDCLASS.
