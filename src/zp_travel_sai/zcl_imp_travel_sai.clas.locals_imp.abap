...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE zi_travel_sai,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zdb_travel_sai FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zdb_tra_dra_sai FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
...
**********************************************************************
* Determination: Default value for Overall status
**********************************************************************

  METHOD setStatusToOpen.

    "Read travel instances of the transferred keys
    READ ENTITIES OF zi_travel_sai IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF zi_travel_sai IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
**    DATA travels_for_update TYPE TABLE FOR UPDATE zi_travel_sai.
...
METHOD copyTravel.
   DATA:
      travels       TYPE TABLE FOR CREATE ZI_TRAVEL_SAI\\travel.
