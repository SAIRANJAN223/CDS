"! @testing BDEF:ZI_TRAVEL_SAI
CLASS zcl_test_travel_sai DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS zcl_test_travel_sai IMPLEMENTATION.
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF ZI_TRAVEL_SAI
     ENTITY Travel
    ...
    SELECT * FROM ZI_TRAVEL_SAI INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
